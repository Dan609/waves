...
\begin{figure}
    ...
    \caption{(A) Fluo-4 raw signal image in spectral view.  (B) 8-Di-ANEPPS raw signal image in spectral view. (C) Fluo-4 raw signal image in normal view with manually selected cardiomyocytes. (D) Fluo-4 raw signal image in normal view with 576 ROI grid. (E) Boxplots of Fluo-4 and 8-Di-ANEPPS raw signal intensities in 40 manually selected cells. (F) Fluo-4 and 8-Di-ANEPPS raw signals intensities plotted against each other.}
    \label{fig:fig4}
\end{figure}
...
Pearson, Kendall and Spearman correlation coefficients show significant negative correlation between \ce{Ca^2+} concentration and \ce{Ca^2+} oscillations frequency
