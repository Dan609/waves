...
calcium <- read.csv('aneppsF0.csv', sep = ',') # Di-8-ANEPPS F0 normalazed signal
...
xcal <- calcium$Y437 # from Y0 to Y575 = ROI1 to ROI576
#--------------------------
...
plot(spy ~ spx, xlab="frequency (Hz)", ylab="spectral density",
     type="l", lwd = 2, main = 'ROI 438 ANEPPS', xlim=c(0,5))
...
write.csv2(peaks, file = 'peaks555.csv')
