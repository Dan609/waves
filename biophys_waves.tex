...
The source of these waves are local high-frequency oscillations \ce{Ca^2+} release (LHFOR) regions, associated with hypercontraction-related damage sites.
...
Under a number of adverse conditions and/or according to individual heart diseases, abnormal forms of \ce{Ca^2+} release from the sarcoplasmic reticulum are observed, which may cause arrhythmogenesis.
