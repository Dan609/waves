...
\begin{figure}[hbt!]
\centering
\includegraphics[width=0.9\linewidth]{fig0.png}
...
# Select signal from 20x20 ROI grid
# fluo.csv - Fluo-4 raw
# fluoF0.csv - Fluo-4 F0 normalazed signal
# anepps.csv - Di-8-ANEPPS raw
# aneppsF0.csv - Di-8-ANEPPS F0 normalazed signal
#------------------------------------------
calcium <- read.csv2('fluo.csv', sep = ',')
...
peaks <- fpeaks(spec(calcium_ts, f=s.rate), nmax = 5,
                threshold = 0.5,
                plot = T,
                title = TRUE,
                xlab = "Frequency (Hz)", ylab = "Amplitude",
