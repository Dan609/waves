...
\textit{Key words:} calcium waves, calcium overloading, cardiomyocytes, myocardium, ischemia, arrhytmia, wavelet coherence
...
Time series analysis in BAR plugin:
...
\caption{clustering and kinesiogramms}
\label{fig:fig2}
\end{figure}
