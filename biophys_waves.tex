        ...
        for (i in 1:l){
                tryCatch({
                        ...
                        peaks <- fpeaks(spec(calcium_ts, f=s.rate),
                              nmax = 10, threshold = 0.5, # set nmax for peaks
...
myfreq('fluoF0.csv')
#-------------------------
# (1) Compute summary statistics for the variable ROI
# (2) Bar plots of sorted freq means
